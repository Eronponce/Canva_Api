  ...
  },
  {
    ...
    result: {
      summary: {
        ...
        total_unique_students_matched: 9,
        total_target_messages: 12,
        total_inactivity_messages: 5,
        total_activity_messages: 7,
        total_never_accessed_matches: 3,
        total_low_activity_matches: 4,
        total_missing_activity_matches: 7,
        total_missing_assignment_matches: 4,
        total_missing_quiz_matches: 7,
        total_activities_checked: 10,
        criteria_mode: "never_accessed,low_total_activity,missing_quiz,missing_assignment",
      ...
      course_results: [
        {
          ...
          activity_messages: 4,
          never_accessed_matches: 2,
          low_activity_matches: 3,
          missing_activity_matches: 4,
          missing_assignment_matches: 2,
          missing_quiz_matches: 4,
          activity_count: 5,
          activity_kind: "mixed",
          activity_filter_available: true,
          recipients_sent: 7,
          status: "success",
          error: "",
        },
...
const engagementTargets = {
  summary: {
    total_courses: 2,
    total_students_found: 54,
    total_matched_students: 14,
    total_unique_students_matched: 11,
    total_target_messages: 14,
    total_inactivity_messages: 6,
    total_activity_messages: 8,
    total_never_accessed_matches: 4,
    total_low_activity_matches: 5,
    total_missing_activity_matches: 8,
    total_missing_assignment_matches: 4,
    total_missing_quiz_matches: 6,
    total_activities_checked: 10,
  ...
  courses: [
    {
      ...
      matched_students: 7,
      target_messages: 9,
      inactivity_messages: 4,
      activity_messages: 5,
      matched_ratio: 25,
      never_accessed_matches: 3,
      low_activity_matches: 3,
      missing_activity_matches: 5,
      missing_assignment_matches: 3,
      missing_quiz_matches: 4,
      activity_count: 5,
      activity_kind: "mixed",
      activity_filter_available: true,
  ...
  items: [
    {
      ...
      reasons_label: "nunca entrou + menos de 10 min",
    },
    {
      course_ref: "33960",
      course_id: 33960,
      ...
      requirement_count: 0,
      activity_type: "mixed",
      activity_type_label: "Quiz e atv avaliativa",
      activity_id: 79412,
      activity_submitted: false,
      activity_count: 5,
      activity_submitted_count: 2,
      activity_missing_count: 3,
      missing_activity_names: ["Quiz 3", "Quiz 4", "Atividade avaliativa"],
      missing_assignment_names: ["Atividade avaliativa"],
      missing_quiz_names: ["Quiz 3", "Quiz 4"],
      missing_activities_label: "Quizzes: Quiz 3, Quiz 4 | Atv avaliativas: Atividade avaliativa",
      reasons_label: "nao fez quiz + nao fez atv avaliativa",
    },
  ],
};
